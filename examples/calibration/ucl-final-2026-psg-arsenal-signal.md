...
|-----------|--------|-------|
| Intelligence | ACTIVE | UCL Final 2026 calibration example: PSG vs Arsenal pre-match signal with verified result |
| Reasoning | ACTIVE | Full five-layer reasoning chain demonstrated for UCL Final (macro→market→sport→athlete→fan token) |
| Context | ACTIVE | Match context: neutral venue (Puskás Aréna), MEDIUM-HIGH confidence, all five layers loaded |
| Memory | ACTIVE | Calibration record 130 — T-48h / T-24h / T-2h signal progression documented |
| Judgment | ACTIVE | Judgment demonstration: neutral venue modifier, Ben White OUT, Kvaratskhelia vs Mosquera advantage |
| Attention | ACTIVE | Signal attention demonstrated: lineup gate, DSM gates, pre-liquidation confirmation |
| Communication | ACTIVE | Calibration communication example: complete structured signal output at T-48h/T-24h/T-2h |
