...
|-----------|--------|-------|
| Intelligence | ACTIVE | Fan digital twin application: personalised fan intelligence profile and engagement prediction |
| Reasoning | ACTIVE | Digital twin reasoning: mapping fan behaviour patterns to engagement and demand signals |
| Context | ACTIVE | Twin context: fan token holdings, governance activity, competition interest, platform behaviour |
| Memory | ACTIVE | Digital twin maintains persistent fan profile and interaction history |
| Judgment | ACTIVE | Judgment on twin signal materiality — active governance participant vs passive holder differ |
| Attention | ACTIVE | Digital twin attention: monitors personalised competition and token events for the fan profile |
| Communication | ACTIVE | Digital twin output: personalised signal feed, engagement opportunity, and demand prediction |
| Verification | ACTIVE | Fan profile data from consented, verified on-chain sources — no inferred PII |
| Learning | ACTIVE | Digital twin patterns improve as fan behaviour and engagement data accumulates |
| Integration | ACTIVE | Integrates fan holder profiles, CHI, fan sentiment, and governance intelligence |
| Calibration | EMERGING | Digital twin demand prediction calibration is developing |
| Adaptation | ACTIVE | Digital twin adapts as fan behaviour patterns and platform features evolve |
| Ethics | ACTIVE | Fan digital twin requires explicit consent — GDPR-compliant aggregate profiling only |
| Transparency | ACTIVE | Data sources, consent basis, and profile components always disclosed in twin output |
