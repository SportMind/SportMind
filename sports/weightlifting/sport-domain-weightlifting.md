...
Olympic weightlifting by weight category. Snatch and clean & jerk.
...
TIER 1 — PRIMARY SIGNAL:
  Combined total ranking, snatch/clean-and-jerk ratio, attempt selection intelligence

TIER 2 — CONTEXTUAL:
  Weight category management, doping risk profile (historical flag context)

EVENT CALENDAR:
  Olympic cycle (peak), IWF World Championships annual
```
...
### Playbook 1: Olympic final by weight category — attempt selection and total analysis
```
