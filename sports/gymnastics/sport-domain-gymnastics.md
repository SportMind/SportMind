# Gymnastics — SportMind Domain Skill
...
Individual and team artistic gymnastics at Olympic and World Championship level.

**Fan token exposure:** No active Chiliz fan tokens as of v3.93.0. National federation tokens possible future.
...
TIER 1 — PRIMARY SIGNAL:
  Difficulty Score (D-score) vs Execution Score (E-score) differential

TIER 2 — CONTEXTUAL:
  Apparatus specialism (all-around vs individual apparatus), home nation judging patterns

EVENT CALENDAR:
  Olympic cycle (quadrennial peak), World Championships (annual), Continental championships
```
...
### Playbook 1: Olympic final — all-around or individual apparatus
```
...
No active Chiliz fan tokens as of v3.93.0. National federation tokens possible future.
