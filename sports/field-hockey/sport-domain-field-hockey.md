# Field Hockey — SportMind Domain Skill
...
International field hockey at FIH Pro League and Olympic Games level.

**Fan token exposure:** No active Chiliz fan tokens as of v3.93.0. Major hockey nations possible future.
...
TIER 1 — PRIMARY SIGNAL:
  Penalty corner conversion rate, possession efficiency in shooting circle, GK save rate

TIER 2 — CONTEXTUAL:
  Surface type (wet vs dry AstroTurf), pitch-side temperature affecting pace

EVENT CALENDAR:
  Olympic cycle (peak), FIH Pro League annual, World Cup quadrennial
```
...
### Playbook 1: Olympic final or World Cup final — penalty corner efficiency analysis
```
...
No active Chiliz fan tokens as of v3.93.0. Major hockey nations possible future.
