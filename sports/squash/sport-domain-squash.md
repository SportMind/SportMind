...
Professional squash on PSA World Tour. Individual racket sport with strong commercial following.
...
TIER 1 — PRIMARY SIGNAL:
  PSA World Ranking differential, head-to-head on surface type (glass court vs traditional)

TIER 2 — CONTEXTUAL:
  Fitness/stamina indicators, match length history, tournament draw path

EVENT CALENDAR:
  PSA World Tour monthly, World Championship (annual), Commonwealth Games cycle
```
...
### Playbook 1: PSA World Championship — top seed vs unseeded opponent
```
