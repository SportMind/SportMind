...
Olympic fencing across three weapons (foil, épée, sabre) and individual/team events.
...
TIER 1 — PRIMARY SIGNAL:
  Weapon specialism ranking, action/reaction speed profile, bout scoring rhythm

TIER 2 — CONTEXTUAL:
  Handedness matchup (left-handed fencers create asymmetric advantage), home nation patterns

EVENT CALENDAR:
  Olympic cycle (peak), FIE World Championships annual, World Cup circuit
```
...
### Playbook 1: Olympic individual weapon final
```
