...
Olympic sailing across multiple boat classes. Wind and tactical racing.
...
TIER 1 — PRIMARY SIGNAL:
  Wind reading capability (start line position conversion), fleet ranking vs individual match

TIER 2 — CONTEXTUAL:
  Weather window during racing (race officer decisions), medal race format vs fleet series

EVENT CALENDAR:
  Olympic cycle (peak), World Sailing World Championships, class world championships
```
...
### Playbook 1: Olympic sailing medal race — fleet position and wind conditions
```
