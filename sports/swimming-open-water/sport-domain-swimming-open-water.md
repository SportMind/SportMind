...
Open water swimming at Olympic (10km) and marathon distances.
...
TIER 1 — PRIMARY SIGNAL:
  Water temperature tolerance profile, pack swimming vs individual breakaway history

TIER 2 — CONTEXTUAL:
  Course currents and conditions, drafting position in pack (tail position advantage)

EVENT CALENDAR:
  Olympic cycle, FINA World Aquatics Championships, World Cup series
```
...
### Playbook 1: Olympic 10km marathon swim — conditions and pack strategy
```
