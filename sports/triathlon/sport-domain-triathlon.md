...
Olympic and Ironman triathlon. Three-discipline sport: swim, cycle, run.
...
TIER 1 — PRIMARY SIGNAL:
  Discipline strength profile (swim/cycle/run split percentages), course type match

TIER 2 — CONTEXTUAL:
  Weather conditions (heat affects run performance strongly), transition time history

EVENT CALENDAR:
  Olympic cycle, ITU World Triathlon Series, Ironman World Championship (Kona)
```
...
### Playbook 1: Olympic Games triathlon — course type and conditions analysis
```
