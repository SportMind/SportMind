...
FAN_TOKEN_REGISTRY = {
    ...
    # --- v3.79.0 additions — Chiliz Chain, verified from chiliscan.com ---
    "NAP":     {"name": "SSC Napoli",               "sport": "football",    "tier": 1,
                "contract": "0xbe7f1ebb1fd6246844e093b04991ae0e66d12c77",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xbe7f1ebb1fd6246844e093b04991ae0e66d12c77",
                "fantokens": "https://www.fantokens.com/trade/napoli"},
    "POR":     {"name": "Portugal National Team",    "sport": "football",    "tier": 1,
                "contract": "0xB0bB080667E52Bd84884d2c90322706C4AA9067b",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xB0bB080667E52Bd84884d2c90322706C4AA9067b",
                "fantokens": "https://www.fantokens.com/trade/portugal-national-team-fan-token"},
    "LUFC":    {"name": "Leeds United",              "sport": "football",    "tier": 2,
                "contract": "0xF67A8a4299f7EBF0c58DbFb38941D0867f300C30",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xF67A8a4299f7EBF0c58DbFb38941D0867f300C30",
                "fantokens": "https://www.fantokens.com/trade/leeds-united-fan-token"},
    "ASM":     {"name": "AS Monaco",                 "sport": "football",    "tier": 2,
                "contract": "0x371863096CF5685cD37AE00C28DE10b6edBab3Fe",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x371863096CF5685cD37AE00C28DE10b6edBab3Fe",
                "fantokens": "https://www.fantokens.com/trade/as-monaco-fan-token"},
    # --- v3.79.0 additions batch 2 — full deep dive from fantokens.com + coinranking ---
    "SPURS":   {"name": "Tottenham Hotspur",         "sport": "football",    "tier": 1,
                "contract": "0x93d84ff2c5f5a5a3d7291b11af97679e75eeac92",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x93d84ff2c5f5a5a3d7291b11af97679e75eeac92",
                "fantokens": "https://www.fantokens.com/trade/tottenham-hotspur-fan-token"},
    "CPFC":    {"name": "Crystal Palace FC",         "sport": "football",    "tier": 2,
                "contract": "0xa70bd29bef2936765fe33b0f4b0cf8e947d75581",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xa70bd29bef2936765fe33b0f4b0cf8e947d75581",
                "fantokens": "https://www.fantokens.com/trade/crystal-palace-fan-token"},
    "EFC":     {"name": "Everton FC",                "sport": "football",    "tier": 2,
                "contract": "0x2cd13acf6f71435896ba906ba8521dd8aae63e00",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x2cd13acf6f71435896ba906ba8521dd8aae63e00",
                "fantokens": "https://www.fantokens.com/trade/everton-fc-fan-token"},
    "ITA":     {"name": "Italy National Team",       "sport": "football",    "tier": 1,
                "contract": "0x280e7e9f8DF76f3f8c6F56D1d54c85e54ba312dad",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x280e7e9f8DF76f3f8c6F56D1d54c85e54ba312dad",
                "fantokens": "https://www.fantokens.com/trade/italy-national-team-fan-token",
                "note": "World Cup 2026 relevance — NCSI ×3.5-4.0 modifier"},
    "SCCP":    {"name": "SC Corinthians",            "sport": "football",    "tier": 2,
                "contract": "0x31F0FcDe2854cF19723d522b5ec0313795068e72",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x31F0FcDe2854cF19723d522b5ec0313795068e72",
                "fantokens": "https://www.fantokens.com/trade/sc-corinthians-fan-token",
                "note": "Rocketfan reports Socios partnership may be expired — monitor"},
    "VERDAO":  {"name": "SE Palmeiras",              "sport": "football",    "tier": 2,
                "contract": "0xb46357d8ed050d35d3a24154c39d7236dae86187",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xb46357d8ed050d35d3a24154c39d7236dae86187",
                "fantokens": "https://www.fantokens.com/trade/se-palmeiras-fan-token"},
    "GALO":    {"name": "Clube Atletico Mineiro",    "sport": "football",    "tier": 2,
                "contract": "0xDD5BE82ad7A0372F0805498A934B5427e0a0129C",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0xDD5BE82ad7A0372F0805498A934B5427e0a0129C",
                "fantokens": "https://www.fantokens.com/trade/atletico-mineiro-fan-token"},
    "SPFC":    {"name": "Sao Paulo FC",              "sport": "football",    "tier": 2,
                "contract": "0x9e8c72A057C8F785A206506E27ee9Af0d8f81a28",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x9e8c72A057C8F785A206506E27ee9Af0d8f81a28",
                "fantokens": "https://www.fantokens.com/trade/sao-paulo-fc-fan-token"},
    "VASCO":   {"name": "Vasco da Gama",             "sport": "football",    "tier": 2,
                "contract": "0x6d72034d7508d16988bf84638d51592a8c02887b",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x6d72034d7508d16988bf84638d51592a8c02887b",
                "fantokens": "https://www.fantokens.com/trade/vasco-da-gama-fan-token"},
    "BFT":     {"name": "Brazil National Team",      "sport": "football",    "tier": 1,
                "contract": "0x4270a3d1a61fc6b86ea9e19730e529acee592c3b",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x4270a3d1a61fc6b86ea9e19730e529acee592c3b",
                "fantokens": "https://www.fantokens.com/trade/brazil-national-team-fan-token",
                "note": "World Cup 2026 host nation — NCSI ×3.5-4.0 modifier"},
    "GOZ":     {"name": "Goztepe S.K.",              "sport": "football",    "tier": 3,
                "contract": "0x0E469D1C78421C7952E4D9626800DAd22F45361D",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x0E469D1C78421C7952E4D9626800DAd22F45361D",
                "fantokens": "https://www.fantokens.com/trade/goztepe-s-k-fan-token",
                "note": "Turkish Socios office closed 2024 — partnership status uncertain"},
    "ALA":     {"name": "Alanyaspor",                "sport": "football",    "tier": 3,
                "contract": "0x863f7537b38130f01a42e9e9406573b1f1e309f7",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x863f7537b38130f01a42e9e9406573b1f1e309f7",
                "fantokens": "https://www.fantokens.com/trade/alanyaspor-fan-token",
                "note": "Turkish Socios office closed 2024 — partnership status uncertain"},
    "IBFK":    {"name": "Istanbul Basaksehir",       "sport": "football",    "tier": 3,
                "contract": "0x916FB58D0c474314AFD399eE50E3528E543e9E9F",
                "chain": "chiliz",
                "chiliscan": "https://chiliscan.com/token/0x916FB58D0c474314AFD399eE50E3528E543e9E9F",
                "fantokens": "https://www.fantokens.com/trade/istanbul-basaksehir-fan-token",
                "note": "Turkish Socios office closed 2024 — partnership status uncertain"},
}

# Multi-chain Fan Token Registry
# These tokens are NOT on Chiliz Chain — different chains, different ecosystems.
# No Fan Token Play mechanics. No chiliscan verification.
# Data quality is lower — always verify contracts directly on-chain before use.
MULTICHAIN_FAN_TOKEN_REGISTRY = {
    "LAZIO":   {"name": "SS Lazio",                  "sport": "football",    "tier": 1,
                "contract": "0x77d547256a2cd95f32f67ae0313e450ac200648d",
                "chain": "BSC (Binance Smart Chain)",
                "bscscan": "https://bscscan.com/token/0x77d547256a2cd95f32f67ae0313e450ac200648d",
                "fantokens": "https://www.fantokens.com/trade/lazio-fan-token",
                "issuer": "Binance",
                "note": "Binance-issued token — different utility model from Socios/Chiliz tokens"},
    "PORTO":   {"name": "FC Porto",                  "sport": "football",    "tier": 2,
                "chain": "BSC (Binance Smart Chain)",
                "fantokens": "https://www.fantokens.com/trade/fc-porto-fan-token",
                "issuer": "Binance",
                "note": "Binance Launchpad token — contract requires verification before use"},
}
